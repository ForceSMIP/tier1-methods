# tier1-methods
Code for methods used in Tier 1 of the ForceSMIP project. Method descriptions can be found in Wills et al. (2025, revised for Journal of Climate). In particular, individual method descriptions and contacts for the method developers can be found in the supplementary material of that paper. 

**Preprint (please check for published verison in Journal of Climate):**
