...
ncvar='monmaxpr'  # CMIP variable name to be used
...
class Dataset(torch.utils.data.Dataset):
  ...
  def __getitem__(self, index):
        ...
        std_monmaxpr=torch.load(outdir+'X_std_tensor_'+list_std+'monmaxpr_v3.pt')
        X = torch.stack(
            (torch.load(outdir+'X_norm_tensor_'+X_ID+'tas_v3.pt')/std_tas,
             ...
             torch.load(outdir+'X_norm_tensor_'+X_ID+'monmaxpr_v3.pt')/std_monmaxpr,
